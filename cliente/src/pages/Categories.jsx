  ...
  return (
    <>
      <div className="flex flex-col p-6">
        <h3 className="text-2xl font-semibold mb-4 shadow-sm border-b py-4">Gestión de Categorías</h3>
        <div className="flex items-center justify-between">
          <Link
            to="/categorias/agregar"
            className="inline-flex items-center px-4 py-2 text-sm font-medium rounded-md shadow-sm text-white bg-gray-600 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
